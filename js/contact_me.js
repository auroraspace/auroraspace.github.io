$(function() {
    ...
    $("#contactForm").submit(function(event) {
        ...
        $.ajax({
            url: "//formspree.io/info@auroraspace.cl",
            type: "POST",
            data: $(this).serialize(),
            dataType: "json",
            cache: false,
            beforeSend: function () {
                ...
                $('#success > .alert-info').append("<strong>Sending...</strong>");
            ...
            error: function () {
                ...
                $('#success > .alert-danger').append("<strong>Ops! An error occurred. Please try again later!");
